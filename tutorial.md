...
gcloud container clusters create "CBCauthen" \
    --region "us-east1" \
...
CBCI_HOSTNAME=CBCauthen.workshop.cb-sa.io
...
```bsh
ping CBCauthen.workshop.cb-sa.io
```
...
The Operations Center for your CloudBees CI cluster should be running or starting up, and available at: [http://CBCauthen.workshop.cb-sa.io]/cjoc](http://CBCauthen.workshop.cb-sa.io]/cjoc])
